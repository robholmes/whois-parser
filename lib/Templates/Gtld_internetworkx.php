...
/**
 * Template for Gtld_internetworkx
 *
 * @category   Novutec
 * @package    WhoisParser
 * @copyright  Copyright (c) 2007 - 2012 Novutec Inc. (http://www.novutec.com)
 * @license    http://www.apache.org/licenses/LICENSE-2.0
 */
class Template_Gtld_internetworkx extends AbstractTemplate
{
	 ...
	 * @access protected
	 */
    protected $blocks = array(1 => '/created-date:(?>[\x20\t]*)(.*?)(?=owner-id)/is', 
            2 => '/owner-id:(?>[\x20\t]*)(.*?)(?=admin-id)/is', 
            3 => '/admin-id:(?>[\x20\t]*)(.*?)(?=tech-id)/is', 
            4 => '/tech-id:(?>[\x20\t]*)(.*?)(?=billing-id)/is', 
            5 => '/billing-id:(?>[\x20\t]*)(.*?)(?=nameserver)/is', 
            6 => '/nameserver:(?>[\x20\t]*)(.*?)$/is');
