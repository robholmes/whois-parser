...
class Socket extends AbstractAdapter
{
    ...
    public function call($query, $config)
    {
        ...
        if ($send != strlen($lookupString . "\r\n")) {
            throw \WhoisParser\AbstractException::factory('WriteError', 'Error while sending data (' .
    ...
    private function connect($config)
    {
        ...
        if (! is_resource($this->sock)) {
            throw \WhoisParser\AbstractException::factory('ConnectError', 'Unable to connect to ' .
