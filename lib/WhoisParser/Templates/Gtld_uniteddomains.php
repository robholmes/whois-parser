...
/**
 * Template for Gtld_uniteddomains
 *
 * @category   Novutec
 * @package    WhoisParser
 * @copyright  Copyright (c) 2007 - 2012 Novutec Inc. (http://www.novutec.com)
 * @license    http://www.apache.org/licenses/LICENSE-2.0
 */
class Template_Gtld_uniteddomains extends AbstractTemplate
{
	 ...
	 * @access protected
	 */
    protected $blocks = array(1 => '/owner-name:(?>[\x20\t]*)(.*?)(?=admin-name)/is', 
            2 => '/admin-name:(?>[\x20\t]*)(.*?)(?=tech-name)/is', 
            3 => '/tech-name:(?>[\x20\t]*)(.*?)(?=billing-name)/is', 
            4 => '/billing-name:(?>[\x20\t]*)(.*?)$/is', 
            5 => '/nameserver1:(?>[\x20\t]*)(.*?)(?=owner-name)/is');
    ...
    protected $blockItems = array(
            1 => array('/^owner-company:(?>[\x20\t]*)(.+)$/im' => 'contacts:owner:organization', 
                    ...
                    '/^owner-postcode:(?>[\x20\t]*)(.+)$/im' => 'contacts:owner:zipcode', 
                    '/^owner-country:(?>[\x20\t]*)(.+)$/im' => 'contacts:owner:country', 
                    '/^owner-telephone:(?>[\x20\t]*)(.+)$/im' => 'contacts:owner:phone', 
                    '/^owner-fax:(?>[\x20\t]*)(.+)$/im' => 'contacts:owner:fax', 
                    '/^owner-email:(?>[\x20\t]*)(.+)$/im' => 'contacts:owner:email'), 
            2 => array('/^admin-company:(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:organization', 
                    ...
                    '/^admin-postcode:(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:zipcode', 
            ...
            3 => array('/^tech-company:(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:organization', 
                    ...
                    '/^tech-postcode:(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:zipcode', 
            ...
            4 => array('/^billing-company:(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:organization', 
                    ...
                    '/^billing-postcode:(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:zipcode', 
                    '/^billing-country:(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:country', 
                    '/^billing-telephone:(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:phone', 
                    '/^billing-fax:(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:fax', 
                    '/^billing-email:(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:email'), 
            5 => array('/^nameserver[0-9]:(?>[\x20\t]*)(.+)$/im' => 'nameserver'));
}