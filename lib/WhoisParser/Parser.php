...
class Parser
{
    ...
    {
        $this->Result = new \WhoisParser\Result();
        $this->Config = new \WhoisParser\Config($this->specialWhois);
        
        try {
            if ($query == '') {
                throw \WhoisParser\AbstractException::factory('NoQuery', 'No lookup query given.');
            }
            ...
            $this->call();
        } catch (\WhoisParser\AbstractException $e) {
    ...
    public function call($query = '')
    {
        ...
        if ($Adapter instanceof AbstractAdapter) {
            ...
            throw \WhoisParser\AbstractException::factory('NoAdapter', 'Adapter ' .
    ...
    private function parse()
    {
        ...
        if ($Template instanceof AbstractTemplate) {
            ...
            throw \WhoisParser\AbstractException::factory('NoTemplate', 'Template ' .
    ...
    {
        if ($Template instanceof Template_Iana) { var_dump($this->rawdata); die; }
